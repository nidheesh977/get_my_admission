...
(function ($) {
	...
	$("#college_landing_enquire_form").on("submit", function(event){
		event.preventDefault()
		enquiryHelper("college_landing_enquire_form")
	})

	$("#view-all-cat").on("click", function(){
		var scrollDiv = document.getElementById("top-colleges").offsetTop;
		window.scrollTo({ top: scrollDiv-120, behavior: 'smooth'});
	})

	$("#faq_enquire_form").on("submit", function(event){
		event.preventDefault()
		enquiryHelper("faq_enquire_form")
	})
