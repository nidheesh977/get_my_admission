<?php include 'inc/header.php' ?>
   <div class="hero-arera course-item-height" data-background="assets/images/contact-banner.jpg">
      <div class="container">
         <div class="row">
            <div class="col-xl-12">
   ...
   <div class="contact-area py-4 py-sm-5">
      <div class="container pt-xl-4 py-3">
         <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="colxl-2 ">
                        <div class="cont-btn mb-20">
                           <input type="submit" class="cont-btn border-0">
                        </div>
                     </div>
                  </div>
               </form>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-8 pt-4 pt-md-0">
                     ...
                     <div class="support-contact-inner">
                        ...
                        <div class="support-item">
                           ...
                           <div class="support-info-location">
                              <span>Location</span>
                              <p>Abbot Kinney Blvd. New York, <br>
                                 USA-5785</p>
                           </div>
                        </div>
                     </div>
            ...
            <div class="google-map-area contact-map col-12 pt-4 pt-md   -5">
               <iframe
